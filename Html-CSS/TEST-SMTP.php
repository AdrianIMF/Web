...
if (mail("naidrannaidran@gmail.com", "Comprobando servicio de Correo -
I", "Mensaje de prueba desde el HOST - Clase de DIW",
    "From: emailtest@diwimf.000webhostapp.com")) {
//Partes función mail//
//Primer Argumento: email donde van a recibirse los datos
//Segundo: La línea de asunto
//Tercero: El Mensaje en sí mismo puede ser código html para envir una página completamente maquetada, pero es importante revisar como llega la codificación de caracteres desde php
//Cuarto: "Cabeceras" que dan forma al email
//Es posible colocar parámetros opcionales como un quinto argumento.
//Pintamos dos mensajes con algo de estilo, uno para cada caso, es decir, en el caso de quetodo funcione, o bien si se produce un error
